...
void ofApp::setup() {
    ...
    ofxGuiSetFont("Questrial-Regular.ttf",35,true,true);
    ofxGuiSetTextPadding(4);
    ofxGuiSetDefaultWidth(550);
    ofxGuiSetDefaultHeight(70);
    gui.setup("Settings");
...
//                    ofSetColor(170, 163, 152, 120);
    ...
    ofSetColor(255, 100);
    if(scene == 0){
        uxMessage = "Move the device around to find a plane.";
    }
    else if (scene == 1){
