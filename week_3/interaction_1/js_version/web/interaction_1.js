...
// Version reutilized for Music Interaction Design, Spring 2019, NYU ITP
...
function draw() {
  ...
  if (modelLoaded && currentFrame[0].x != NaN) {
    ...
    if (poses.length == 0) {
      ...
      distY = int(127 * abs(currentFrame[0].y + distRef - currentFrame[3].y) / (3 * dShoulders));
      console.log(distY);
    }
